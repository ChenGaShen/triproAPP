...
public class Recruitment {
    ...
    //配置您申请的KEY
    public static final String JHAPPKEY =SystemParam.JH_Partnerkey;
 
    //1.常用快递查询API
    public static JSONObject getRequest1(  Map<String,Object> params){
        String result =null;
        JSONObject object=null;
        String url ="http://v.juhe.cn/exp/index";//请求接口地址
//            params.put("com","");//需要查询的快递公司编号
//            params.put("no","");//需要查询的订单号
          params.put("key",JHAPPKEY);//应用APPKEY(应用详细页查询)
