...
var TableInit = function() {
	...
	oTableInit.Init = function() {
		$('#t_table').bootstrapTable({
			url : '../admin/validate/findByPage.json', // 请求后台的URL（*）
			method : 'post', // 请求方式（*）
			data :[],
			dataType: 'json',
...
//			showRefresh : true, // 是否显示刷新按钮
			...
			columns : [ {
	            ...
	            formatter:function(value,row,index){
				  ...
				  field: 'phone', // 返回json数据中的name
	              title: '账户手机', // 表格表头显示文字
	              align: 'center', // 左右居中
	              valign: 'middle', // 上下居中
	            	  
			}, {
				  field: 'validateCode', // 返回json数据中的name
	              title: '验证码', // 表格表头显示文字
	              align: 'center', // 左右居中
	              valign: 'middle' ,// 上下居中
			}, {
				  field: 'validateType', // 返回json数据中的name
	              title: '类型', // 表格表头显示文字
	              align: 'center', // 左右居中
	              valign: 'middle',// 上下居中
	              formatter : function(value, row, index) { 
...
*/			pageSize: params.pageSize, // 页面大小 多少条记录
    ...
    $('#btn_query').click(function(){
        $('#t_table').bootstrapTable('refresh', {url: '../admin/validate/findByPage.json'});
       /* 
        再点击查询按钮时 
        （分页后重新搜素问题） 
